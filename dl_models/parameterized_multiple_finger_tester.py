...
def main(the_data_folder, weights_path, cuda, output_dir, num_anchors, num_pos, num_neg, \
    ...
    final_results = {
        ...
        MEAN_NEG_DIST_KEY: np.mean(_02_dist - _01_dist), STD_NEG_DIST_KEY: np.std(_02_dist - _01_dist),
        MEAN_TRIPLET_DIST_KEY: np.mean(_02_dist), STD_TRIPLET_DIST_KEY: np.std(_02_dist),
