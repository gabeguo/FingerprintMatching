...
COMBINED_RACE="sd302_white_and_non-white_split"
MALE_GROUP="sd302_male_split"
FEMALE_GROUP="sd302_female_split"
COMBINED_GENDER="sd302_male_and_female_split"

######
# Training demographic models
######
#for category in $CAUCASIAN_DESCENT $NON_CAUCASIAN $COMBINED_RACE $MALE_GROUP $FEMALE_GROUP $COMBINED_GENDER
for category in $COMBINED_RACE $COMBINED_GENDER
do
